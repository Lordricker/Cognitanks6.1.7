...
public class TankAssembly : MonoBehaviour
{
    ...
    public void Assemble(TankSlotDataJson data)
    {
        ...
        GameObject deathExplosionPrefab = Resources.Load<GameObject>("Vefects/Free Fire VFX URP/Particles/VFX_Fire_01_Big_Simple");
        ...
        {
            Debug.LogWarning($"TankAssembly: Could not load death explosion prefab from Resources/Vefects/Free Fire VFX URP/Particles/VFX_Fire_01_Big_Simple for {gameObject.name}");
        }
